...
\]
它把方差中的平方项换成了 $x$ 和 $y$ 的\textoverset{Cross Term}{交叉项}，并由此体现出了\textoverset{Correlation}{相关关系}。
...
这里以美国人类学家Richard McElreath搜集到的一个\uhref{https://github.com/rmcelreath/rethinking/blob/master/data/Howell1.csv}{数据集}为例，它的分布是这样的
\input{howell1.tex}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[>=Stealth, scale=1.5]
